...
namespace Persistencia.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Tarea",
                columns: new[] { "IdTarea", "CategoriaId", "Descripcion", "FechaVencimiento", "Titulo", "UsuarioId" },
                values: new object[] { 1, 1, "Completar el informe de ventas del último trimestre.", new DateTime(2024, 4, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Completar informe de ventas", 1 });
